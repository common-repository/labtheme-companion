...
// register Labtheme_Featured_Page_Widget widget
function labtheme_register_featured_page_widget() {
    register_widget( 'Labtheme_Featured_Page_Widget' );
}
add_action( 'widgets_init', 'labtheme_register_featured_page_widget' );
 
 /**
 * Adds Labtheme_Featured_Page_Widget widget.
 */
class Labtheme_Featured_Page_Widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'labtheme_featured_page_widget', // Base ID
            __( 'Lab Theme: Featured Page Widget', 'labtheme-companion' ), // Name
            array( 'description' => __( 'A Featured Page Widget', 'labtheme-companion' ), ) // Args
        );
    }
...
} // class Labtheme_Featured_Page_Widget

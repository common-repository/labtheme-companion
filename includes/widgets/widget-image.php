...
// register Labtheme_Image_Widget widget
function labtheme_register_image_widget(){
    register_widget( 'Labtheme_Image_Widget' );
}
add_action('widgets_init', 'labtheme_register_image_widget');
 
 /**
 * Adds Labtheme_Image_Widget widget.
 */
class Labtheme_Image_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
			'labtheme_image_widget', // Base ID
			__( 'Lab Theme: Image Widget', 'labtheme-companion' ), // Name
			array( 'description' => __( 'An Image Widget.', 'labtheme-companion' ), ) // Args
		);
    }
    ...
    public function widget( $args, $instance ) {
        ...
        ob_start();
        ?>
            <div class="labtheme-iw-holder">
                <div class="labtheme-iw-inner-holder">
                    <?php
        ...
        <?php
        $html = ob_get_clean();
        echo apply_filters( 'labtheme_companion_image_widget', $html, $args, $title, $content, $image, $link, $label );   
	...
	public function form( $instance ) {
        ...
        $sizes   = $obj->labtheme_get_all_image_sizes();
        ?>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'link' ) ); ?>"><?php esc_html_e( 'Featured Link', 'labtheme-companion' ); ?></label> 
        ...
        <p>    
            <label for="<?php echo esc_attr( $this->get_field_id( 'size' ) ); ?>"><?php esc_html_e( 'Image Size', 'labtheme-companion' ); ?></label> 
        </p>
        <select id="<?php echo esc_attr( $this->get_field_id( 'size' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'size' ) ); ?>">
            <option value=""><?php _e('Select image size','labtheme-companion');?></option>
            <?php

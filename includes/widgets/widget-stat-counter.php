...
// register Labtheme_Companion_Stat_Counter_Widget widget
function labtheme_stat_counter_widget(){
    register_widget( 'Labtheme_Companion_Stat_Counter_Widget' );
}
add_action('widgets_init', 'labtheme_stat_counter_widget');
 
 /**
 * Adds Labtheme_Companion_Stat_Counter_Widget widget.
 */
class Labtheme_Companion_Stat_Counter_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'Labtheme_companion_stat_counter_widget', // Base ID
            __( 'Lab Theme: Stat Counter Widget', 'labtheme-companion' ), // Name
            array( 'description' => __( 'Widget for stat counter.', 'labtheme-companion' ), ) // Args
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        if ( is_active_widget( false, false, $this->id_base, true ) ) {
            ...
            wp_enqueue_script( 'odometer', LABTC_FILE_URL . '/public/js/odometer.min.js', array( 'jquery' ), '0.4.6', false );
            wp_enqueue_script( 'waypoint', LABTC_FILE_URL . '/public/js/waypoint.min.js', array( 'jquery' ), '2.0.3', false );
        }
            ...
            <div class="labtheme-sc-holder">
                ...
                if( $image ){ ?>
                    ...
                    <div class="icon-holder">
                        <?php do_action( 'widget_labtheme_stat_counter_before_icon' ); ?>
        ...
        <?php
        $html = ob_get_clean();
        echo apply_filters( 'labtheme_companion_stat_counter', $html, $args, $title, $icon, $counter, $ran );  
        ...
        $html = ob_get_clean();
        echo apply_filters( 'labtheme_companion_stat_counter_widget_filter', $html, $args, $instance );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'counter' ) ); ?>"><?php esc_html_e( 'Counter', 'labtheme-companion' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'comma' ) ); ?>"><?php esc_html_e( 'Disable Comma(,) Separation', 'labtheme-companion' ); ?></label>
        </p>
...
}  // class Labtheme_Companion_Stat_Counter_Widget
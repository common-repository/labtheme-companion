...
// register Labtheme_Recent_Post widget
function labtheme_register_recent_post_widget() {
    register_widget( 'Labtheme_Recent_Post' );
}
add_action( 'widgets_init', 'labtheme_register_recent_post_widget' );
 
 /**
 * Adds Labtheme_Recent_Post widget.
 */
class Labtheme_Recent_Post extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'labtheme_recent_post', // Base ID
            __( 'Lab Theme: Recent Post Widget', 'labtheme-companion' ), // Name
            array( 'description' => __( 'A Recent Post Widget', 'labtheme-companion' ), ) // Args
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $title      = ! empty( $instance['title'] ) ?  $instance['title'] : __( 'Recent Posts', 'labtheme-companion' );
        ...
        $cats[] = '';
        $cat = apply_filters_ref_array( 'labtheme_exclude_categories', $cats );
        $target = 'target="_self"';
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['title']          = ! empty( $new_instance['title'] ) ? sanitize_text_field( $new_instance['title'] ) : __( 'Recent Posts', 'labtheme-companion' );
